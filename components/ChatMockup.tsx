    ...
    >
      ...
      <div className="bg-[#1E293B] px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 mx-4">
          <div className="bg-[#0F172A] rounded-md px-4 py-1 flex items-center justify-center">
      ...
      {/* Área del chat */}
      <div className="bg-[#0F172A] p-6 space-y-4 min-h-[320px]">
        ...
        <div className="flex items-start gap-3 max-w-[85%]">
          ...
          <div className="bg-[#1E293B] text-white text-sm rounded-2xl rounded-tl-none px-4 py-3 leading-relaxed">
        ...
        <div className="flex items-start gap-3 max-w-[85%] ml-auto flex-row-reverse">
          <div className="w-8 h-8 rounded-full bg-[#334155] flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">
            Tú
          </div>
          <div className="bg-[#5B5CF6] text-white text-sm rounded-2xl rounded-tr-none px-4 py-3 leading-relaxed">
